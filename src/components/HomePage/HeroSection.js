...
function HeroSection() {
    return (
        <div className='bg-gradient-to-b from-[#F1F7ED] h-screen flex justify-center items-center '>
            <div className='w-1/2 text-center p-16'>
                <h1 className='font-amaticSc text-6xl text-[#CF5C36]'>EASY ACCESS TO DELICIOUS RECIPES MADE JUST FOR
                    YOU</h1>
